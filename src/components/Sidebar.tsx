...
const navItems = [
  ...
  { href: '/upload', label: 'Manage Knowledge Base', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
  { href: '/chat', label: 'Test Your AI', icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z' },
  { href: '/setup', label: 'Widget', icon: 'M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4' },
